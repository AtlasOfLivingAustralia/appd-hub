...
//set a null default value to force people to assign roles
authorise.roles=""
...
log4j = {
    ...
    appenders {
        environments {
            production {
                rollingFile name: "tomcatLog", maxFileSize: 102400000, file: "/var/log/tomcat7/appd-hub.log", threshold: org.apache.log4j.Level.ERROR, layout: pattern(conversionPattern: "%d %-5p [%c{1}] %m%n")
